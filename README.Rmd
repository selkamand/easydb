...
[![CRAN status](https://www.r-pkg.org/badges/version/easydb)](https://CRAN.R-project.org/package=easydb)
...
![GitHub closed issues](https://img.shields.io/github/issues-closed-raw/selkamand/easydb)
[![Download Stats](http://cranlogs.r-pkg.org/badges/easydb)](https://cran.r-project.org/package=easydb)
"[![Download Grand Total](http://cranlogs.r-pkg.org/badges/last-month/grand-total)](https://cran.r-project.org/package=grand-total)"
<!-- badges: end -->
